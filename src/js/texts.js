...
Texts.derivationdone = ['Is in DNV?', 'Check if derivation is complete']
...
Texts.exlogeq = ['Logische equivalentie', 'Prove logical equivalence']
Texts.exdnv = ['Disjunctieve normaalvorm', 'Convert to disjunctive normal form']
Texts.excnv = ['Conjunctieve normaalvorm', 'Convert to conjunctive normal form']
Texts.on = ['AAN', 'ON']
Texts.off = ['UIT', 'OFF']
