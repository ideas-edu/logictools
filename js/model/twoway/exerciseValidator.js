/*global LogEXSession, Rules, IdeasServiceProxy */
/**
...
function TwoWayExerciseValidator() {
    ...
    this.validateSteps = function (exercise, index1, index2, onValidated, onErrorValidatingStep) {
        var self = this,
            checkRule = exercise.usesRuleJustification,
            step1,
            step2,
            state,
            formula,
            rule = null,
            onError = onErrorValidatingStep,
    ...
    this.validateExercise = function (exercise, stepIndex1, stepIndex2, onValidated, onErrorValidatingExercise) {
        var self = this,
            index1 = Math.max(stepIndex1,0), //Eerste index van de te controleren stap is 1 (indien < 1, tel eentje bij: heeft geen nut om stap 0 (=opgave) te controleren
            index2 = Math.max(stepIndex2,1),
    ...
    this.validateStep = function (exerciseType, step1, step2, onValidated, onErrorValidatingStep) {
        var self = this,
            state = [exerciseType, step1.strategyStatus, step1.equation.getText(), step1.strategyLocation],
            formula = step2.equation.getText(),
            rule = null,
            onError = onErrorValidatingStep,
