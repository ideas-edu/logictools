...
function TwoWayStepCollection(baseStep) {
    ...
    */
    ...
    this.removeBottomSteps = function (index) {
        var filteredSteps = [],
            formula = this.steps[0].equation.formula2, // voor reset van de top steps naar de nieuwe bottomstep
            stepCount = 0,
            i;
    ...
    this.removeTopSteps = function (index) {
        var filteredSteps = [],
            formula = this.steps[0].equation.formula1, // voor reset van de bottom steps naar de nieuwe topstep
            stepCount = 0,
            i;
        for (i = 0; i < this.steps.length; i += 1) {
