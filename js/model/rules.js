...
var absorbtie                     = ["Absorptie", "Absorption"];
// var associativiteit               = ["Associativiteit", "Associativity"];
var commutativiteit               = ["Commutativiteit", "Commutativity"];
var de_morgan                     = ["De Morgan", "De Morgan"];
var distributie                   = ["Distributie", "Distribution"];
var dubbele_negatie               = ["Dubbele negatie", "Double negation"];
var equivalentie_definitie        = ["Equivalentie-eliminatie", "Equivalention definition"];
var F_regel_complement            = ["F-regel complement", "F-rule complement"];
var F_regel_conjunctie            = ["F-regel conjunctie", "F-rule conjunction"];
var F_regel_disjunctie            = ["F-regel disjunctie", "F-rule disjunction"];
var F_regel_niet_T                = ["F-regel niet T", "F-rule not T"];
var implicatie_definitie          = ["Implicatie-eliminatie", "Implication definition"];
var idempotentie                  = ["Idempotentie", "Idempotency"];
var T_regel_complement            = ["T-regel complement", "T-rule complement"];
var T_regel_conjunctie            = ["T-regel conjunctie", "T-rule conjunction"];
var T_regel_disjunctie            = ["T-regel disjunctie", "T-rule disjunction"];
var T_regel_niet_F                = ["T-regel niet F", "T-rule not F"];
